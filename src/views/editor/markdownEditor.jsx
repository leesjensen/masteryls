...
export default function MarkdownEditor({ content, diffContent, onChange, commit }) {
  ...
  const insertAiSection = () => {
    const sectionTemplate = `\n\n## AI Generated Section\n\n*This section was generated by AI.*\n\n`;
    insertText(sectionTemplate);
  };

  const insertAiQuiz = () => {
    const quizWithUuid = defaultMultipleChoiceQuizTemplate.replace(/"id":""/, `"id":"${crypto.randomUUID()}"`).replace(/"body":".*"/, `"body":"*This quiz was generated by AI.*"`);
    insertText(quizWithUuid);
  };
