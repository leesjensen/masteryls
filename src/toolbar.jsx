...
export default function Toolbar({ config, sidebarVisible, manipulateSidebar, topic, changeTopic, navigateToAdjacentTopic, toggleEditor }) {
  ...
  function displaySchedule() {
    ...
    changeTopic({ name: 'Schedule', path: config.links.schedule });
  }
  ...
  return (
    <div className="flex flex-row justify-between border-b-1 border-gray-200">
      ...
      <div className="flex flex-row justify-end">
        ...
        <button className="w-8 m-1 p-1.5 text-xs font-medium rounded-full border border-gray-200 bg-white shadow-sm hover:bg-amber-400 hover:text-white hover:shadow-md transition-all duration-200 ease-in-out" onClick={() => window.open(config.course.chat, '_blank')}>
          💬
        </button>
        <button className="w-8 m-1 p-1.5 text-xs font-medium rounded-full border border-gray-200 bg-white shadow-sm hover:bg-amber-400 hover:text-white hover:shadow-md transition-all duration-200 ease-in-out flex items-center justify-center" onClick={() => window.open(config.course.canvas, '_blank')}>
        ...
        <button className="w-8 m-1 p-1.5 text-xs font-medium rounded-full border border-gray-200 bg-white shadow-sm hover:bg-amber-400 hover:text-white hover:shadow-md transition-all duration-200 ease-in-out flex items-center justify-center" onClick={() => window.open(gitHubUrl(topic.path), '_blank')}>
