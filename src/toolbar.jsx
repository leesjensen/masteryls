  ...
  return (
    <div className="flex flex-row justify-between border-b-1 border-gray-200">
      ...
      <div className="flex flex-row justify-end">
        {course.schedule && (
          <button className="w-8 m-1 p-1.5 text-xs font-medium rounded-sm bg-transparent border border-transparent filter grayscale hover:grayscale-0 hover:border-gray-200 hover:shadow-sm transition-all duration-200 ease-in-out" onClick={() => displaySchedule()}>
            📅
          </button>
        )}
        {course.links?.chat && (
          <button className="w-8 m-1 p-1.5 text-xs font-medium rounded-sm bg-transparent border border-transparent filter grayscale hover:grayscale-0 hover:border-gray-200 hover:shadow-sm transition-all duration-200 ease-in-out" onClick={() => window.open(course.links.chat, '_blank')}>
            💬
          </button>
        )}
        {course.links?.canvas && (
          <button className="w-8 m-1 p-1.5 text-xs font-medium rounded-sm bg-transparent border border-transparent filter grayscale hover:grayscale-0 hover:border-gray-200 hover:shadow-sm transition-all duration-200 ease-in-out flex items-center justify-center" onClick={() => window.open(course.links.canvas, '_blank')}>
