...
class Service {
   ...
   */
  async makeCanvasGradebookRequest(params: { courseId: string; catalogId?: string; topicType: 'exam' | 'project' | 'dra' | 'interview' | 'mastery'; percentCorrect: number; pointsPossible: number; canvasAssignmentId?: number | string; canvasQuizId?: number | string; learnerEmail?: string; autoGrade?: boolean; feedback?: string; submissionUrl?: string; submissionText?: string; dateDue?: string | null }) {
