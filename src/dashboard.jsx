  ...
  return (
    <div className='grid'>
      <button
        key={courseInfo.id}
        type='button'
        onClick={() => select(courseInfo)}
        className='col-start-1 row-start-1 flex flex-col items-center p-6 rounded-xl bg-gray-50 shadow-md min-h-[280px] transition-transform duration-200 focus:outline-none hover:scale-102 hover:shadow-lg cursor-pointer'
      >
