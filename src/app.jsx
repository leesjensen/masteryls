    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-row justify-between border-b-1 border-gray-200">
        ...
        <div className="flex flex-row justify-end">
          <button className="w-8 m-1 px-2 py-1 text-xs border rounded hover:bg-amber-300" onClick={() => displaySchedule()}>
            📅
          </button>
          <button className="w-8 m-1 px-2 py-1 text-xs border rounded hover:bg-amber-300" onClick={() => window.open(config.course.chat, '_blank')}>
            💬
          </button>
          <button className="w-8 m-1 px-2 py-1 text-xs border rounded hover:bg-amber-300 flex items-center justify-center" onClick={() => window.open(config.course.canvas, '_blank')}>
          ...
          <button className="w-8 m-1 px-2 py-1 text-xs border rounded hover:bg-amber-300 flex items-center justify-center" onClick={() => window.open(gitHubUrl(topic.path), '_blank')}>
          ...
          <button className="w-8 m-1 px-2 py-1 text-xs border rounded hover:bg-amber-300" onClick={() => navigateToAdjacentTopic('prev')}>
            ⬅
          </button>
          <button className="w-8 m-1 px-2 py-1 text-xs border rounded hover:bg-amber-300" onClick={() => navigateToAdjacentTopic('next')}>
            ⮕
          </button>
        </div>
      </div>
