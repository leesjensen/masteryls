...
export default function QuizInstruction({ courseOps, topic, user, preview = null, exam = false }) {
  ...
  function injectQuiz(content) {
    ...
    return (
      <div className="px-4 py-4 bg-white rounded border border-blue-300 shadow-sm overflow-x-auto break-words whitespace-pre-line" data-plugin-masteryls data-plugin-masteryls-root data-plugin-masteryls-id={meta.id} data-plugin-masteryls-title={meta.title} data-plugin-masteryls-type={meta.type}>
        <fieldset>
