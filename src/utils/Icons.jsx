...
import { Video, Images, BookCheck, ClipboardCheck, File, CalendarDays } from 'lucide-react';
...
export function Canvas({ size = 16 }) {
  return (
    <svg width={size} height={size} x="0px" y="0px" viewBox="298 -66.2 217 244.4" xmlns="http://www.w3.org/2000/svg">
      <g>
        <g>
